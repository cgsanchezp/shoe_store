...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
   <tr> 
	 ...
	 <!-- InstanceBeginEditable name="titulo" --><?php echo $row_DatosProducto['strNombre']; ?><!-- InstanceEndEditable --> <br/>
	 <!-- InstanceBeginEditable name="contenido" -->
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					{?>
                    Necesitas <a href="alta_usuario.php">Registrarte</a> para comprar. Es gratuito.
<?php }?></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
