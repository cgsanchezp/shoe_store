...
<title>Finalizaci&oacute;n de Pago</title>
<!-- InstanceEndEditable -->
...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
   <tr> 
	 ...
	 <!-- InstanceBeginEditable name="titulo" -->Finalizaci&oacute;n de Pago<!-- InstanceEndEditable --> <br/>
     ...
     <?php if ($_POST["radio"] == 2)
	  ...
	  ?>
                ...
                <p>Deber&aacute;s remitirnos un email con la certificaci&oacute;n de tu pago a zapatos@zapatos.com, realizado a este n&uacute;mero de cuenta:</p>
