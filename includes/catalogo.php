...
<?php do { ?>
  <li class="bg_list"><a href="categoria_ver.php?cat=<?php echo $row_Recordset1['idCategoria']; ?>"><?php echo $row_Recordset1['strDescripcion']; ?></a></li>
...
if ((isset($_SESSION['MM_Username'])) && ($_SESSION['MM_Username'] != ""))
  {
     ...
     <li class="bg_list"> <a href="carrito_lista.php" class="modificacionusuario">Carrito de la Compra</a> </li>
...
<?php
  ...
  {?><br />
 <li class="bg_list"> <a href="alta_usuario.php">Registrarme</a></li>
 <li class="bg_list"><a href="acceso.php">Acceder</a></li> 
<?php }?>
</ul></td>