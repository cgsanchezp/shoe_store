...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
   <tr> 
	 ...
	 <!-- InstanceBeginEditable name="titulo" -->Seleccionar la Forma de Pago<!-- InstanceEndEditable --> <br/>
	 <!-- InstanceBeginEditable name="contenido" -->
     
       <p>Elije la forma de pago:</p>
                <form id="form1" name="form1" method="post" action="carrito_finalizacion1.php">
                  <p>
