...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
   <tr> 
	 ...
	 <!-- InstanceBeginEditable name="titulo" -->Bienvenido<!-- InstanceEndEditable --> <br/>
	 <!-- InstanceBeginEditable name="contenido" -->Muchas gracias por acceder <!-- InstanceEndEditable --><br> 
       <br></td>
   </tr> 	
</table> 
