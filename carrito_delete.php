...
if ((isset($_GET['recordID'])) && ($_GET['recordID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tblcarrito WHERE idProducto=%s",
...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
   <tr> 
	 ...
	 <!-- InstanceBeginEditable name="titulo" -->ELIMINANDO PRODUCTO DE LA CESTA<!-- InstanceEndEditable --> <br/>
	 <!-- InstanceBeginEditable name="contenido" -->Eliminando...<!-- InstanceEndEditable --><br> 
       <br></td>
   </tr> 	
</table> 
