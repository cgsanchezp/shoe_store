...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
   <tr> 
	 ...
	 <!-- InstanceBeginEditable name="titulo" -->A&ntilde;adir Producto<!-- InstanceEndEditable --> <br/>
	 <!-- InstanceBeginEditable name="contenido" -->A&ntilde;adir <!-- InstanceEndEditable --><br> 
       <br></td>
   </tr> 	
</table> 
