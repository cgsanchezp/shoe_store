...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
   <tr> 
	 ...
	 <!-- InstanceBeginEditable name="titulo" -->Cerrando Sesi&oacute;<!-- InstanceEndEditable --> <br/>
	 <!-- InstanceBeginEditable name="contenido" -->Muchas gracias por comprar en nuestro sitio. <!-- InstanceEndEditable --><br> 
       <br></td>
   </tr> 	
</table> 
