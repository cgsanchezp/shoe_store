   ...
   <tr> 
     ...
     <?php if ($totalRows_DatosCarrito > 0) { // Show if recordset not empty ?>
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           				  <td bgcolor="#69A620"><span class="Estilo1">Producto</span></td>
                          <td bgcolor="#69A620"><span class="Estilo1">Unidades</span></td>
                          <td bgcolor="#69A620"><span class="Estilo1">Precio</span></td>
                          <td bgcolor="#69A620"><span class="Estilo1">Acciones</span></td>
                      </tr>
         <?php $preciototal = 0;?>
         <?php do { ?>
           <tr class="brillo">
             <td><?php echo ObtenerNombreProducto($row_DatosCarrito['idProducto']); ?></td>
             <td><?php echo $row_DatosCarrito['intCantidad']; ?>
               </td>
             <td><?php echo ObtenerPrecioProducto($row_DatosCarrito['idProducto']); ?> Soles</td>
             <td><a href="carrito_delete.php?recordID=<?php echo $row_DatosCarrito['idProducto']; ?>">Eliminar </a> 
   <!--  -   <a href="carrito_actualizar.php?recordID=">Actualizar</a>--></td>
           </tr>
       ...
       <a href="carrito_forma_pago1.php">Seleccionar Forma de Pago</a>
       <?php }else {
