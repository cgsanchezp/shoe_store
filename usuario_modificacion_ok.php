...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
   <tr> 
	 ...
	 <!-- InstanceBeginEditable name="titulo" -->Muchas gracias<!-- InstanceEndEditable --> <br/>
	 <!-- InstanceBeginEditable name="contenido" -->Hemos registrado tus datos nuevos. <!-- InstanceEndEditable --><br> 
       <br></td>
   </tr> 	
</table> 
