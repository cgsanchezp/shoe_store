...
<?php
// Pregunta si existe la funcion GetSQLValueString
if (!function_exists("GetSQLValueString")) {
// Se crea la funcion con los patametros requeridos
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
// Se obtiene la version del PHP
  if (PHP_VERSION < 6) {
    $theValue = get_magic_quotes_gpc() ? stripslashes($theValue) : $theValue;
  }

  $theValue = function_exists("mysql_real_escape_string") ? mysql_real_escape_string($theValue) : mysql_escape_string($theValue);
// Busca los tipos de datos que hay en cada caja de texto existente en el formulario
  switch ($theType) {
    case "text":
...
// Si se agrego correctamente  redireccionamos la pagina a  productos_lista.php
...
// Se selecciona el tipo de conecion para poder obtener la tabla categoria
mysql_select_db($database_conexionzapatos, $conexionzapatos);
// Obtenermos la consulta a la BD
...
// Separamos los datos obtenidos en columnas
$row_ConsultaCategorias = mysql_fetch_assoc($ConsultaCategorias);
// Obtenemos el numero de filas obtenidas de las consultas
