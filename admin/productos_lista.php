...
// Selecciona la cantidad maxima que va a tener las filas de la tabla.
$maxRows_Recordset1 = 10;
// El numero de paginas que se va a mostrar 
$pageNum_Recordset1 = 0;
{ // Recibe por variable el numero de paginacion
if (isset($_GET['pageNum_Recordset1'])) {
  $pageNum_Recordset1 = $_GET['pageNum_Recordset1'];
}
// Multiplica el numero de paginas con el numero maximo de filas y guarda en una variable
$startRow_Recordset1 = $pageNum_Recordset1 * $maxRows_Recordset1;
// Se conecta con la BD para hacer la consulta
...
//Convierte las variable a un formato string y almacena en una variable nueva
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
// Se ejecuta con la base de datos o sino termina la conexion
$Recordset1 = mysql_query($query_limit_Recordset1, $conexionzapatos) or die(mysql_error());
//Separa los datos obtenidos y los guarda en un array cada fila
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
// Pregunta si existte la variable obtenida por el GET
if (isset($_GET['totalRows_Recordset1'])) {
// Si existe guarda esa variable GET en $totalRows_Recordset1
  $totalRows_Recordset1 = $_GET['totalRows_Recordset1'];
} else {
// Obtiene la variable de la consulta y la ejecuta guardando en una variable el resultado
  $all_Recordset1 = mysql_query($query_Recordset1);
  // La variable obtenida la separa en columnas y la guarda en una variable $totalRows_Recordset1
  $totalRows_Recordset1 = mysql_num_rows($all_Recordset1);
}
//  Obtiene las variable creadas y las redondea guardando en una variable $totalPages_Recordset1
...
<table border="0" width="" cellspacing="0" cellpadding="0"> 
  ...
  <tr class="tablaprincipal">
    <td bgcolor="#66A31F"  >Nombre Producto</td>
    <td bgcolor="#66A31F"  >Estado</td>
    <td bgcolor="#66A31F"  >Acciones</td>
  </tr>
  <?php do { ?>
  <tr class="brillo">
